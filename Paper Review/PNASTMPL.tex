...
\section{Method}
Since the full knowledge of the states and information of the search engine are not available, the algorithm behaves according to only the feedback from the search engine in the form of ads.

\subsection{Simulations}

\subsubsection{Simulation 1}

Vivamus magna enim, alique
